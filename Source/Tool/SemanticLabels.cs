...
namespace RimLife
{
    /// <summary>
    /// 将裸数值映射为语义标签。
    /// 阈值尽量复用 RimWorld 内置常量或枚举；不发明新词汇。
    /// 所有方法均为纯函数，线程安全。
    /// </summary>
    public static class SemanticLabels
    {
        ...
        /// <summary>
        /// 疼痛等级标签。
        /// 阈值参考 RimWorld PainCategoryDef 体系。
        /// </summary>
        ...
        /// <summary>
        /// 心情等级标签。
        /// 阈值参考 RimWorld 精神崩溃阈值体系
        /// (ExtremeBreak ~0.01, MajorBreak ~0.12, MinorBreak ~0.28)。
        /// </summary>
        ...
        /// <summary>
        /// 失血严重度标签。
        /// HediffSet.BleedRateTotal 致命线约 0.6。
        /// </summary>
        ...
        /// <summary>
        /// 社交好感度标签。
        /// RimWorld 社交 opinion 范围大约 -100 ~ +100。
        /// </summary>
        ...
        /// <summary>
        /// 热舒适度标签。
        /// 参考 GenTemperature 舒适区间 (室内 ~12-32°C，室外更宽)。
        /// </summary>
