...
namespace RimLife.Driver
{
    ...
    public class PromptConfig
    {
        ...
        public static string DefaultDirectorPrompt =>
            _cachedDirectorPrompt ?? (_cachedDirectorPrompt = LoadPromptResource("RimLife.Prompts.DirectorPrompt.txt"));

        /// <summary>编剧 Agent 默认系统提示词（不含动态上下文和台词格式）。</summary>
        public static string DefaultScreenwriterPrompt =>
            _cachedScreenwriterPrompt ?? (_cachedScreenwriterPrompt = LoadPromptResource("RimLife.Prompts.ScreenwriterPrompt.txt"));

        /// <summary>Freelancer Agent 默认系统提示词（不含动态上下文和台词格式）。</summary>
        public static string DefaultFreelancerPrompt =>
            _cachedFreelancerPrompt ?? (_cachedFreelancerPrompt = LoadPromptResource("RimLife.Prompts.FreelancerPrompt.txt"));
