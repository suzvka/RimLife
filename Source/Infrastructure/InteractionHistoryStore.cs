...
namespace RimLife.Infrastructure
{
    ...
    public class InteractionHistoryStore : IInteractionStore, IDisposable
    {
        ...
        private void SaveToStore()
        {
            ...
            {
                Log.Warning($"[RimLife.InteractionStore] Failed to save interactions: {e.Message}");
            }
        }
        ...
        private void LoadFromStore()
        {
            try
            {
                ...
                Log.Message($"[RimLife.InteractionStore] Loaded {_records.Count} interactions from save.");
            }
            catch (Exception e)
            {
                Log.Warning($"[RimLife.InteractionStore] Failed to load interactions: {e.Message}");
            }
        }
